...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	const { apiConfiguration, currentTaskItem, currentTaskId } = useExtensionState() // Add currentTaskId
					...
					<div
						...
						<div
							...
							<span style={{ fontWeight: "bold" }}>
								...
								{/* Display Task ID */}
								{currentTaskId && (
									<span className="ml-2 text-xs text-vscode-descriptionForeground opacity-75">
